...
export const antikKentYapilari: ParsedLocationData[] = [
  {
    isim: "Agora-kuzey Stoa (bazilika)",
    aciklama: "",
    koordinatlar: {
      enlem: 38.419126711412,
      boylam: 27.13905906148,
    },
    adres: {
      ilce: "Konak",
      mahalle: "Namazgah",
  ...
  {
    isim: "Arkaik Dönem Teras Ve Kanal Duvarı",
    aciklama:
    ...
    koordinatlar: {
      enlem: 38.659384121559,
      boylam: 26.752237056564,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Atatürk",
  ...
  },
  {
    ...
    koordinatlar: {
      enlem: 39.091934976438,
      boylam: 26.917214236102,
    },
    adres: {
      ilce: "Dikili",
      mahalle: "Cumhuriyet",
  ...
  },
  {
    ...
    koordinatlar: {
      enlem: 38.319507835196,
      boylam: 26.304892953612,
    },
    adres: {
      ilce: "Çeşme",
      mahalle: "Musalla",
  ...
  {
    isim: "Bağlararası Tunç Dönemi Yerleşimi",
    aciklama:
      "Musalla Mahallesi Bağarası Mevkii'nde yer almaktadır. Bölgede 2001-2005 yılları arasında yapılan kurtarma kazılan sonucunda ortaya çıkarılmıştır. Kalıntılar; Erken ve Orta Tunç dönemine ait olmakla birlikte, kazı çalışmaları sırasında bölgede Geç Tunç Çağında da yerleşildiğini gösteren küçük buluntular ele geçmiştir. Dönemine göre oldukça gelişmiş bir şehir planı mevcuttur. Binalar; taş temel üzerine kerpiç malzeme ile inşa edilmiştir. Evlerin içinde müstakil ocak ve fırınları vardır. Bitişik yapılarda dahi ortak ara duvar kullanılmamış olması keskin bir mülkiyet ayrımı bilinci oluştuğunu göstermektedir. Orta Tunç Dönemi yerleşiminde ortaya çıkarılan şarap işliği ünik bir yapı olup döneminin şarap üretim tarzı hakkında bilgi vermesi bakımından oldukça önemli bir bulgudur.",
    koordinatlar: {
      enlem: 38.31974611299,
      boylam: 26.304290081118,
    },
    adres: {
      ilce: "Çeşme",
      mahalle: "Musalla",
  ...
  },
  {
    ...
    koordinatlar: {
      enlem: 38.082376437261,
      boylam: 28.208730074362,
    },
    adres: {
      ilce: "Beydağ",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Akropol Ve Küçük Sunak",
    aciklama:
    ...
    koordinatlar: {
      enlem: 37.947187825468,
      boylam: 27.343511198622,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Anıtsal Çeşme",
    aciklama:
      "M.S. 2. yüzyılda inşa edilmiş  ve M.S. 4. yüzyılda da restore edilmiştir. Anıtsal Çeşme`nin suyu bugünkü adı Dervent Deresi olan ve Efes ören yerinden 6 km. doğuda bulunan Marnas Nehri`nden M.S. 4 ile 14 yılları arasındaki bir tarihte Gaius Sextilius Pollio tarafından yaptırılan su kemeri aracılığı ile geliyordu.       ",
    koordinatlar: {
      enlem: 37.936195620095,
      boylam: 27.343452043369,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Arkadiane (liman Caddesi)",
    aciklama:
      "Liman ile Tiyatro arasında, Geç Helenistik, Erken Roma Çağı`ndan beri mevcut olan cadde  M.S. 359 ve 366 yıllarındaki depremlerden sonra İmparator Arkadius Dönemi`nde yapılan onarım ve düzenlemeler nedeniyle Arkadiane ismiyle anılmaktadır. 500 m. uzunluğunda ve 11 m. genişliğindedir. Güneşten ve yağmurdan korunmuş mozaik döşeli yaya yolu olan cadde boyunca bir dizi spor alanı ile iki yanında galerilerin, dükkânların bulunduğu şehrin en önemli caddesinde törenler, şenlikler ve önemli geçitler yapılmaktaydı.. Kralların karşılandığı bir çok önemli gösterinin ve dini törenin yapıldığı cadde aynı zamanda limana gelen ve giden tüm mal ve servetin aktığı yol olduğundan  Liman Caddesi olarak anılır.  Caddenin altında şehrin atık suyunu limana kadar taşıyan kanalizasyon sistemi  vardır. Kral Yolu da denilen cadde yazıtlardan anlaşıldığı üzere geceleri yağ kandilleri ile aydınlatılıyordu. M.S. 5. yüzyılda caddenin orta kısmında, basamaklı kaideler üzerinde yükselen dört sütunlu bir anıt yapılmıştır. Bunların 2 m. yükseklikteki kaidelerinde Hıristiyanlık sembolleri olan nişler ve süslemeler vardır. Sütun başlıklarının üzerinde dört incil yazarının heykellerinin var olduğu kabul edilir.  ",
    koordinatlar: {
      enlem: 37.942032323104,
      boylam: 27.340204086329,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Aşk Evi",
    aciklama:
      "İmparator Traianus-Hadrianus  dönemlerinde (MS 98-136) inşa edilip sonradan onarılan iki katlı ev; arkada Latrina (Genel Tuvaletler) ve Skolastika Hamamı ile ortak bir yapı oluşturur. Üst kattaki ve alt katta odaların yer aldığı konağın duvarları içinde bugünün modern klima sistemine eşdeğer bir soğutma ve ısıtma sistemi bulunmaktaydı. Evin baş salonu, tabanında dört mevsimi simgeleyen renkli mozaikleri ile olasılıkla `Triklinium` denilen yemek odasını oluşturuyordu. Bunun hemen yanında banyo odası yer alır. Bir mozaikte ortada içki içen üç kadın ve ayakta bir hizmetçi, yerde bir fare ve kedi figürlerinin ince bir işçilikle işlendiği görülür. Duvarları freskli tabanı mozaik döşeli odalar, mozaikli havuzlar, şarap mahzenleri, dev ocaklar, hamamlar, konferans salonları ile muhteşem bir kütüphanesi bulunduğu bilinmektedir.    ",
    koordinatlar: {
      enlem: 37.939063585413,
      boylam: 27.341787874751,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Liman Gymnasiumu Ve Liman Hamamı",
    aciklama:
      "Efes kentinin en büyük mimarî topluluğu olan Liman Gymnasionu ve hamamlarının ayakta bulunan kalıntıları çok etkileyicidir.  Biri 90×90 m., öteki 200×240 m. ölçüsünde olmak üzere iki palaestrası (beden hareketlerinin yapıldığı yer) bulunan, uzunluğunun tamamı 360 m. olan Gymnasion`un büyük palestrası 13 çeşit renkteki mermer plakalarla kaplanmıştır. Küçük palestranın kuzeydeki salonu imparator kültüne, güneydeki de derslere ve toplantılara ayrılmış olmalıdır. Güney salonda bulunan M.Ö.4.yy.`da yapılmış bronz atlet heykelinin güzel bir Roma kopyası Viyana Müzesi`nde sergilenmektedir. Yapı topluluğunun hamam kısımları da büyük kalıntılar halinde ayakta durmaktadır. Domitianus Dönemi(M.S. 2.)`nde inşasına başlanan 160x170 m ebatlarında 28 m yüksekliğindeki  hamam yapısı MS. 356 yılı depreminde kısmen yıkılmış ve tekrar onarılmıştır.                     ",
    koordinatlar: {
      enlem: 37.943080894772,
      boylam: 27.337861204322,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Mazeus Mithridates (agora Güney) Kapısı",
    aciklama:
      "Celsus Kütüphanesi`nden Ticaret Agorası`na (Aşağı Agora) geçişi sağlayan, Roma zafer takı mimari tarzında inşa edilmiş, 3 geçitli kapı;  M.Ö. 3.-4. yüzyıllarda; Augustus, karısı Livia, kızı Julia ve damadı Agrippa&#39;ya adanmak üzere; Augustust tarafından özgürlükleri bağışlanan Mazeus ve Mithridates isimli köleler tarafından yaptırılmıştır.  ",
    koordinatlar: {
      enlem: 37.939407336384,
      boylam: 27.341146497501,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Memmius Anıtı",
    aciklama:
      "M.S. 1. yüzyılda Büyük  Roma`nın diktatörlerinden birisi olan Sulla`nın torunu C. Memmius adına onursal bir yapı olarak dikilmiştir.  Dört cepheli, iki katlı yapının  birinci katının baştabanına, hem Latince hem de Yunanca olarak kazınmış olan yazıt; bu yapıya ismini vermiştir. Yapının doğu ucunda bulunan Latince bir yazıtta ``Kaius Memmiyus, kurtarıcımız, Kaius`un oğlu, Cornelyus Sulanın torunudur.`` yazmaktadır.  Memmiyus ailesinin fertlerine ait olan ve de bu kişilerin bireysel özelliklerinin kişileştirilmiş olarak heykel haline dönüştürüldüğü örnekler ikinci katta bulunan üç adet galerideki, sütunlar arasında yer almıştır. Figürlerden bazıları Memmiyus`u, babası Caius`u ve dedesi diktatör Sulla ile başlık giyen askerleri temsil etmektedir.            ",
    koordinatlar: {
      enlem: 37.937360958282,
      boylam: 27.34340479543,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Odeion",
    aciklama:
      "İzleyicilerin oturduğu kademeli bölümü(cavea), sahne yapısı, koro için ayrılmış dans alanı ile küçük bir tiyaro görünümündedir. M.S. 150 yıllarına tarihlenen, 1.400 kişilik üstü kapalı yapı Belediye Binası olarak Boule(Danışma Meclisi) toplantılarına, Odeion olarak da konserlere, tiyatro oyunlarına sahne olmuştur.       ",
    koordinatlar: {
      enlem: 37.93692259041,
      boylam: 27.344924945043,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Stadyum Caddesi",
    aciklama: "",
    koordinatlar: {
      enlem: 37.945815319962,
      boylam: 27.343276112642,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Vedius Gymnasiumu",
    aciklama:
      "Efes`in önde gelen  varlıklı kişilerinden olan Publius Vedius Antoninus ve karısı Flavia Papiona tarafından  M.S.150 tarihinde dostu ve hamisi imparator Antonius Pius ile tanrıça Artemis adına yaptırılmıştır. Kentin kuzey sur çizgisi üstünde inşa edilen avlulu, hamamlı, tören salonlu yapı, yanındaki stadium ile birlikte işlevsel bir bütünlük taşımaktadır. Avlusu sütunlu olan iki katlı 20x10 m ebatlarında imparator salonunun bitişiğinde çeşitli odaları, tuvaleti ve hamamı bulunmaktaydı. Döneminde fiziksel ve zihinsel etkinliklerin yapıldığı bir çeşit okul olan Gymnasium`un spor slanının anıtsal girişi, zamanında heykellerle süslüydü. Kazılarında ele geçen Kaystros(Küçük Menderes) heykeli bugün Kültürpark`taki İzmir Tarih ve Sanat Müzesi`nde sergilenmektedir.             ",
    koordinatlar: {
      enlem: 37.947484837835,
      boylam: 27.34492286611,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Efes (ephesos) Yukarı Agora (devlet Agorası) Ve Bazilika",
    aciklama:
    ...
    koordinatlar: {
      enlem: 37.936480142928,
      boylam: 27.344815974418,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  },
  {
    isim: "Efes Tiyatrosu",
    aciklama:
      "Roma İmparatorluğu döneminde M.S.2. yüzyılın başında inşa edilen Tiyatro Gymnasion`u hem beden hareketlerinin yapıldığı bir yer hem de küçük stadyum olarak işlev görüyordu. Spor-eğlenme alanı, 30x70 m ebatlarında olup, 3 tarafı sütunlu üstü örtülü, açık galerilerden oluşur. Dördüncü kenarında ise izleyici oturma yerleri bulunan yapı; hamamı, ders salonları, kitaplık, konferans salonları ile tam bir komplekstir. Kuzeydeki 5 odanın ortasında imparatorluk salonu da bulunmaktadır.    ",
    koordinatlar: {
      enlem: 38.42855771302,
      boylam: 26.944833288192,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Atatürk",
  ...
  {
    isim: "Foça Beşkapılar Kalesi",
    aciklama:
      "Bizans imparatoru Mihail Paleolog tarafından 1275 yılında Cenevizli Manuel Zacharnaya verilmiş ve zaman içerisinde Cenevizliler tarafından surları onarılmıştır. Foçanın 1455 yılında Osmanlı topraklarına katılmasından sonra surlar onarılarak, bugün dokuz tanesini ayırt edebileceğimiz kulelerle donatılmıştır. Osmanlı Döneminde kayıkhane olan bölüm, günümüzde Açıkhava Tiyatrosu olarak kullanılmaktadır.    ",
    koordinatlar: {
      enlem: 38.669174100423,
      boylam: 26.750817116295,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Atatürk",
  ...
  },
  {
    ...
    koordinatlar: {
      enlem: 38.024707848974,
      boylam: 27.422137784477,
    },
    adres: {
      ilce: "Selçuk",
      mahalle: "Belevi",
  ...
  },
  {
    ...
    koordinatlar: {
      enlem: 38.362494202934,
      boylam: 26.775694474527,
    },
    adres: {
      ilce: "Urla",
      mahalle: "İskele",
  ...
  {
    isim: "Metropolis Bizans Kalesi",
    aciklama:
      "Helenistik çağda kalmadır. Bizans döneminde, Arap akınlarına karşı önlem olarak güçlendirilmiş ve genişletilmiştir.  Kale, kesme taş ve moloz taştan yapılmış ve yerleşim alanının büyük bir kısmını çevreleyen surlarla desteklenmiştir. Duvar örgülerinde antik yapılara ait mimari parçalar ve heykeller kullanılmıştır. Büyük kulenin kuzeydoğu köşesinde, büyük taş blokları ile savunma tesisleri kurulmuştur.      ",
    koordinatlar: {
      enlem: 38.125871910459,
  ...
  {
    isim: "Metropolis Bouleuterion (meclis Binası)",
    aciklama:
      "Bouleuterion, şehir yaşamı ile ilgili önemli kararları veren kent meclisinin toplandığı yapı anlamına gelir. Bizans surları tarafından ikiye bölünen Bouleuterion yapısı, kareye yakın bir plana sahiptir. Yapı, ele geçen mimari ve plastik buluntulara göre Geç Hellenistik devre tarihlenir. Atina Yeni Bouleuterion ile başlayan ve Miletos Bouleuterionu ile devam eden meclis binası geleneğinin önemli bir örneğidir.  ",
    koordinatlar: {
      enlem: 38.125905178078,
      boylam: 27.323755450814,
    },
    adres: {
      ilce: "Torbalı",
      mahalle: "Yeniköy",
  ...
  {
    isim: "Myrina Akhaion Limanı",
    aciklama: "Limandan günümüze, liman taşları dışında birşey kalmamıştır.      ",
    koordinatlar: {
      enlem: 38.848138545638,
      boylam: 26.982910150825,
    },
    adres: {
      ilce: "Aliağa",
      mahalle: "Çaltılıdere",
  ...
  {
    isim: "Myrina Antik Tiyatrosu",
    aciklama:
      "Tam olarak ortada olmasa da, İlk çağ ve Bizans sur parçalarının yanında tiyatronun yeri kendini belli etmektedir. Henüz kazı çalışmaları yapılmamıştır.    ",
    koordinatlar: {
      enlem: 38.84687194983,
      boylam: 26.979894009764,
    },
    adres: {
      ilce: "Aliağa",
      mahalle: "Çaltılıdere",
  ...
  {
    isim: "Osmanlı-ceneviz Sur Duvarı",
    aciklama: "",
    koordinatlar: {
      enlem: 38.669818082217,
      boylam: 26.751879767741,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Atatürk",
  ...
  {
    isim: "Pergamon Amfitiyatrosu",
    aciklama: "",
    koordinatlar: {
      enlem: 39.125765546076,
      boylam: 27.174324587539,
    },
    adres: {
      ilce: "Bergama",
      mahalle: "Atmaca",
  ...
  {
    isim: "Phokaia Anatanrıça (kybele) Adak Nişleri",
    aciklama:
      "Roma dönemi öncesinde, muhtemelen Arkaik dönemde (M.Ö. 6. yüzyıl) yapılmıştır. Kayalara oyulmuş bu nişlere mermer kabartmalar yerleştirilmiştir. Kentin doğusunda yeldeğirmenlerinin bulunduğu tepenin üzerinde bu tip nişlerin sayısı oldukça fazladır. Batı Anadoluda bulunan Athena tapınaklarının yakınlarındaki kayalıklarda da bu tür nişlere çok rastlanır; bu nedenle Anatanrıçanın Athena ile birlikte birçok yerde tapım gördüğü anlaşılmaktadır.   ",
    koordinatlar: {
      enlem: 38.668582753574,
      boylam: 26.759735136722,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Fevzipaşa",
  ...
  {
    isim: "Phokaia Antik Tiyatrosu",
    aciklama:
      "Anadolunun en eski tiyatrosudur. M.Ö. 340-330 yıllarına tarihlenen tiyatro, son dönem kazılarında bulunmuştur. M.S. I.yyda seramik çöplüğü, II.yyda da nekropolis olarak (mezarlık) kullanılmıştır. Roma döneminde bir etkinlik göstermemesi, bu dönemde kentte başka bir tiyatro olduğunu düşündürmekte, ancak bu henüz saptanamamıştır. Tiyatro, dayanıklı bir taş türü olmayan ve yörede Foça Taşı olarak anılan tüf taşından yapılmıştır.       ",
    koordinatlar: {
      enlem: 38.67014299413,
      boylam: 26.758970404366,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Fevzipaşa",
  ...
  {
    isim: "Phokaia Arkaik Duvarı (heredot Duvarı)",
    aciklama:
    ...
    koordinatlar: {
      enlem: 38.663690531247,
      boylam: 26.760666109183,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Fevzipaşa",
  ...
  {
    isim: "Phokaia Athena Tapınağı Kalıntıları",
    aciklama: "",
    koordinatlar: {
      enlem: 38.668749080849,
      boylam: 26.753192127224,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Atatürk",
  ...
  {
    isim: "Phokaia İlk Yerleşim Alanı",
    aciklama:
      "Kentin güneyindeki yamaçlarda  Phokaia`nın ilk yerleşim alanında yapılan kazılarda Oryantalizan Dönem megaronlarının altında Protogeometrik Dönem oval evleri ortaya çıkarıldı. Erken Protogeometrik Dönem`e ait iki ayrı oval evin varlığı bu alanda Ionların yerleştiğini; aynı alanda bulunan Myken ve Gri Minyas seramiği ve daha alt seviyelerde M.Ö. 3. ve 2. bin yerleşim izlerine seramiklerle birlikte rastlanılmış olması,  M.Ö. 3. binden beri Phokaia`nın varolduğunu  gösterir.         ",
    koordinatlar: {
      enlem: 38.660563482725,
      boylam: 26.753285143464,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Atatürk",
  ...
  {
    isim: "Phokaia Kuzey Nekropol Alanı",
    aciklama: "",
    koordinatlar: {
      enlem: 38.672525331813,
      boylam: 26.756657655511,
    },
    adres: {
      ilce: "Foça",
      mahalle: "İsmetpaşa",
  ...
  {
    isim: "Phokaia Yeldeğirmenleri Ve Kybele Kutsal Alanı",
    aciklama:
      "18. veya 19. yüzyıla ait ve kısmen korunmuş bu üç yeldeğirmeninin bulunduğu tepenin üzerinde antik çağda Ana Tanrıçanın (Kybele) kutsal ulanı bulunmaktaydı. Bu alana, tepenin güneybatısındaki kayalara oyulmuş merdivenlerle ulaşılmaktaydı. Bu çevrede kayalara oyulmuş 150 kadar adak nişi bulunmaktadır. Bu nişlerin bazıları kabartmalı olarak yapılırken içleri düz olanlara mermer kabartmalar konulmuştur. Nişler, Arkaik, Klasik ve Hellenistik dönemlerden (M.Ö. 7.ve 1. yüzyıllar) kalmadır.             ",
    koordinatlar: {
      enlem: 38.669380309322,
      boylam: 26.760441084176,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Fevzipaşa",
  ...
  {
    isim: "Smyrna Kazı Evi",
    aciklama: "Hizmet binası",
    koordinatlar: {
      enlem: 38.464196486103,
      boylam: 27.16936017557,
    },
    adres: {
      ilce: "Bayraklı",
      mahalle: "Tepekule",
  ...
  {
    isim: "Smyrna Toplantı Megaronu",
    aciklama: "",
    koordinatlar: {
      enlem: 38.464563939325,
      boylam: 27.170222926205,
    },
    adres: {
      ilce: "Bayraklı",
      mahalle: "Tepekule",
  ...
  },
  {
    isim: "Şeytan Hamamı",
    aciklama:
      "Antik çağda kayalara oyularak yapılmış bir aile mezarıdır. Mezar, uzun bir yol ve iki mezar odasından oluşmuştur. Çan tepesinin eteğinde yer alır ve kaya mezar tipindedir. Ord. Prof. Ekrem AKURGAL ın yapmış olduğu kazılar sırasında bulunan seramik mezarın, M.Ö. 4.yy a ait olduğu ortaya konmuştur.  ",
    koordinatlar: {
      enlem: 38.66142207419,
      boylam: 26.744117404869,
    },
    adres: {
      ilce: "Foça",
      mahalle: "Atatürk",
  ...
  },
  {
    isim: "Teos / Agora",
    aciklama:
      "Kentin Agora ve Gymnasium kısımlarında çok az araştırma yapılmıştır. Agora, akropolün güneyinde, Bouleuteriona bitişik şekildedir. M.Ö. 7. yüzyıla kadar inen seramik buluntularına rastlanmıştır.  ",
    koordinatlar: {
      enlem: 38.176479875718,
      boylam: 26.790606969374,
    },
    adres: {
      ilce: "Seferihisar",
      mahalle: "Sığacık",
  ...
  {
    isim: "Teos / Bouleuterion (meclis Binası)",
    aciklama:
    ...
    koordinatlar: {
      enlem: 38.177672510244,
      boylam: 26.790171352982,
    },
    adres: {
      ilce: "Seferihisar",
      mahalle: "Sığacık",
  ...
  },
  {
    isim: "Teos / Gymnasium",
    aciklama:
      "Akropolün kuzeydoğusunda yer alan Gymnasiumun büyük bir kısmı halen toprak altındadır. Küçük sondajlar ve yüzey buluntuları ışığında, gymnasiumun Helenistik dönemde inşa edildiği ve Roma döneminde değişikliğe uğradığı söylenmektedir.  ",
    koordinatlar: {
      enlem: 38.183320681737,
      boylam: 26.788927194605,
    },
    adres: {
      ilce: "Seferihisar",
      mahalle: "Sığacık",
  ...
  {
    isim: "Teos / Helenistik Tiyatro",
    aciklama:
      "Tiyatro, Akropol tepesinin güney yamacına, doğal eğim kullanarak kurulmuştur. Roma döneminde sahne binası genişletilmiş ve Caveayı yükseltebilmek için altına tonozlu geçitler (vomitorium) yapılmıştır. Özellikle Bizans döneminde büyük tahribat görmüş olan tiyatronun oturma taşları kale yapımlarında kullanılmıştır.  ",
    koordinatlar: {
      enlem: 38.179906493312,
      boylam: 26.787638657129,
    },
    adres: {
      ilce: "Seferihisar",
      mahalle: "Sığacık",
  ...
  {
    isim: "Tepecik Höyüğü Alman Kulesi (şarap Fabrikası)",
    aciklama:
      "Tepecik, İzmir ilinde sevimli bir semttir. Semt tepecik adını sınırları içinde yer alan ve halk arasında (Alman kulesi ) denilen 18 metre rakımlı küçük bir tepeden alır. Alman kulesi denmesinin nedeni Alman Ignatz Müller’in şarap fabrikasının ve bağ evinin bulunmasıdır. Dikkatli bir şekilde bakıldığında tepede binaların temellerini görmek mümkündür. Söylentilerde bu tepeden Kadifekaleye tüneller olduğu bilgisi vardır.\nAslında bu tepe milattan önce 8500 yıllarından bile eski değerleri taşıyan bir HÖYÜKTÜR.",
    koordinatlar: {
      enlem: 38.424762820568,
      boylam: 27.159668394019,
    },
    adres: {
      ilce: "Konak",
      mahalle: "Yenişehir",
